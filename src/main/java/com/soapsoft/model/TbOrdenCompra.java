...
public class TbOrdenCompra  implements java.io.Serializable {
    ...
    public TbOrdenCompra(int id, TbProveedor tbProveedor, int creadorPor, Date creadoEn, String modificadoPor, Date modificadoEn, String observacion, Set<TbDetalleOrdenCompra> tbDetalleOrdenCompras) {
       this.id = id;
       this.tbProveedor = tbProveedor;
       this.creadorPor = creadorPor;
       this.creadoEn = creadoEn;
