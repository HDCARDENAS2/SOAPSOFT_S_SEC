...
public class TbProveedor  implements java.io.Serializable {
     ...
     private Set<TbOrdenCompra> tbOrdenCompras = new HashSet<TbOrdenCompra>(0);
    ...
    public TbProveedor(String nit, String razonSocial, String contacto, String telefono, String celular, String direccion, boolean estado, String creadoPor, Date creadoEn, String modificadoPor, Date modificadoEn, Set<TbOrdenCompra> tbOrdenCompras) {
       this.nit = nit;
       this.razonSocial = razonSocial;
       this.contacto = contacto;
       this.telefono = telefono;
    ...
    public Set<TbOrdenCompra> getTbOrdenCompras() {
        return this.tbOrdenCompras;
    }
    
    public void setTbOrdenCompras(Set<TbOrdenCompra> tbOrdenCompras) {
        this.tbOrdenCompras = tbOrdenCompras;
    }
